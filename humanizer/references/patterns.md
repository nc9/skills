# Pattern catalogue: core AI tells (1-24, 47-65)

Full before/after examples for the numbered patterns indexed in `SKILL.md`.
Blog-specific patterns 25-32 live in `blog-patterns.md`; detector-driven patterns
33-46 live in `detector-testing.md`.
...
**Problem:** ChatGPT uses curly quotes (U+201C/U+201D, as in “smart quotes”) instead of straight ASCII quotes (U+0022, as in "dumb quotes"). Same for curly apostrophes (’ vs '). AI also overuses Unicode arrows (→, ←) and other decorative characters in running prose.
